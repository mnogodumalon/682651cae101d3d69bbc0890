...
import UnternehmensverwaltungDetailPage from '@/pages/UnternehmensverwaltungDetailPage';
import SchichteinteilungPage from '@/pages/SchichteinteilungPage';
import SchichteinteilungDetailPage from '@/pages/SchichteinteilungDetailPage';
import SchichtartenverwaltungPage from '@/pages/SchichtartenverwaltungPage';
import SchichtartenverwaltungDetailPage from '@/pages/SchichtartenverwaltungDetailPage';
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="unternehmensverwaltung/:id" element={<UnternehmensverwaltungDetailPage />} />
                <Route path="schichteinteilung" element={<SchichteinteilungPage />} />
                <Route path="schichteinteilung/:id" element={<SchichteinteilungDetailPage />} />
                <Route path="schichtartenverwaltung" element={<SchichtartenverwaltungPage />} />
                <Route path="schichtartenverwaltung/:id" element={<SchichtartenverwaltungDetailPage />} />
