// Auto-generated. Per-entity form-enhancements config for "Unternehmensverwaltung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["unternehmen_name", "unternehmen_plz", "unternehmen_notiz", "unternehmen_ort", {"row": ["unternehmen_strasse", "unternehmen_hausnummer"], "cols": "2fr 1fr"}],
  defaults: {},
  computed: {},
};
